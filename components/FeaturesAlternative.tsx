    ...
    <section ref={sectionRef} className="bg-neutral-bg py-24 border-t border-neutral-line">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mt-20 fade-in-up delay-200ms">
            ...
            {/* Feature Card 1 */}
            <div className="bg-white rounded-[2rem] overflow-hidden shadow-premium border border-gray-100 flex flex-col hover:shadow-premium-hover transition-all duration-300">
                <div className="bg-gradient-to-b from-purple-50 to-white p-10 flex items-center justify-center h-72">
                     {/* UI Visual - Catalog */}
                     <div className="relative w-full max-w-[240px]">
                        <div className="absolute top-0 right-0 -mr-4 -mt-4 w-full h-full bg-purple-200/30 rounded-xl transform rotate-6"></div>
                        <div className="relative bg-white rounded-xl shadow-lg border border-gray-100 p-4 transform -rotate-2 transition-transform hover:rotate-0 duration-500">
             ...
             {/* Feature Card 2 */}
             <div className="bg-white rounded-[2rem] overflow-hidden shadow-premium border border-gray-100 flex flex-col hover:shadow-premium-hover transition-all duration-300">
                <div className="bg-gradient-to-b from-blue-50 to-white p-10 flex items-center justify-center h-72 relative overflow-hidden">
                     {/* UI Visual - Launcher */}
                     <div className="relative w-full max-w-[260px] bg-white rounded-xl shadow-xl border border-gray-100 p-5 transform transition-transform hover:scale-105 duration-500">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <div className="text-[10px] font-mono text-gray-400">campaign_v2.ts</div>
                        </div>
                        <div className="space-y-3">
                            ...
                            <div className="h-8 w-full bg-gray-900 rounded-lg flex items-center justify-center">
             ...
             {/* Feature Card 3 */}
             <div className="bg-white rounded-[2rem] overflow-hidden shadow-premium border border-gray-100 flex flex-col hover:shadow-premium-hover transition-all duration-300">
                <div className="bg-gradient-to-b from-green-50 to-white p-10 flex items-center justify-center h-72">
                     {/* UI Visual - AI Chat */}
                     <div className="w-full max-w-[240px] space-y-3">
                        ...
                        <div className="flex justify-start">
                            <div className="bg-white text-gray-700 text-[11px] py-2.5 px-4 rounded-2xl rounded-tl-sm shadow-sm border border-gray-100 max-w-[90%] font-medium leading-relaxed">
                                <span className="text-brand-purple font-bold text-[9px] block mb-1 uppercase tracking-wider">AI AGENT</span>
